...
def start():
	...
	driver = webdriver.Chrome(chrome_options=chrome_options)
        driver.get('https://www.randomlists.com/last-names')
        sleep(1)
        
	generate = driver.find_element_by_xpath('/html/body/div/div[1]/div[2]/main/div[1]/div[1]/div/button[1]')
	generate.click()
	sleep(2)
	...
	collection = []
	for i in range(1, 13):
		element = "/html/body/div/div[1]/div[2]/main/div[1]/div[2]/ol/li["+str(i)+"]/span"
